...
Check up-to-date 
https://github.com/AustinZhang/deep-speech

Usage: from speech_io.feature_io import *

OBS = read_scp(r'\\vilfblgpu020\D\users\zhashi\BNFeat\scps\BNDNN_BN_1300hr.mfc.head.fakechunk')

...
# def read_examples(configfile):       # config file:
#
#
...
#     o_utt, utt_dict =read_scp(SCPfile)
#
#
#     """Read statelist """
#     #dict_state = {}
...
#     # check SCP files missing in MLF
#     final_utt_list = [u for u in o_utt.keys() if u in s_utt.keys()]
#     remove_utt_list = [u for u in o_utt.keys() if u not in s_utt.keys()]
#     print "the following utterances from SCP are not in MLF: ", remove_utt_list
#
#
#     """Read cdbn """

...
def read_mlffile(filename, utt_dict):
    ...
    return s_utt
    # len(s_utt)
    # s_utt[0][0] = 'fcjf0_si1657'
    # s_utt[0][1] = ('h#_s2', 'h#_s3', 'h#_s4', 'q_s2', 'q_s2', 'q_s2', ......, 'th_s4', 'th_s4', 'th_s4', 'h#_s2', 'h#_s2', 'h#_s2', 'h#_s3', 'h#_s3', 'h#_s3', 'h#_s3', 'h#_s3', 'h#_s3', 'h#_s4')
    # s_utt[r][0] =
    # s_utt[r][1] =
...
def read_statelist(filename):
    ...
    for line in open(filename):
        ...
        state=state.rstrip(']').replace('[','_s')
        dict_state[state]=int(ind)

    print(len(dict_state), "states mapped to [0,1,2,...]")
    print(dict_state)
    return dict_state
